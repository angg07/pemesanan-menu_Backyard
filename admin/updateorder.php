...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit2'])) {
        ...
        $query = mysqli_query($con, "insert into orderhistory(orderId,status,keterangan) values('$oid','$status','$keterangan')");
    ...
    <div id="content">
        ...
        <form name="updateticket" id="updateticket" method="post">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <?php
                $ret = mysqli_query($con, "SELECT * FROM orderhistory WHERE orderId='$oid'");
                ...
                if ($st == $currrentSt) { ?>
                    ...
                    <tr>
                        ...
                        <td class="fontkink" align="justify"><span class="fontkink">
                                <textarea cols="50" rows="7" name="keterangan" required="required">Orderan Telah Selesai</textarea>
                            </span></td>
                    </tr>
                    <tr>
