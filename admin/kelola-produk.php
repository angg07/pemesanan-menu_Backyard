        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td width=200px><img src="productimages/<?php echo htmlentities($row['productImage']); ?>" alt="<?php echo htmlentities($row['productName']); ?>" class="img-fluid img-thumbnail" ></td>
                    <td width="15%">
