...
if (isset($_POST['submit'])) {
    $sql = mysqli_query($con, "SELECT password FROM supervisor where password='" . md5($_POST['password']) . "' && username='" . $_SESSION['slogin'] . "'");
    $num = mysqli_fetch_array($sql);
    if ($num > 0) {
        $qry = mysqli_query($con, "update supervisor set password='" . md5($_POST['newpassword']) . "'where username='" . $_SESSION['slogin'] . "'");
...
<head>
    ...
    <title>Page Supervisor - Backyard</title>
